...
import aboutbg from '../../Assets/blogbg.png'
const BlogHead = () => {
  return (
    ...
    <div className="flex flex-col items-center justify-center h-full  relative z-10">
        <h1 className="text-6xl md:text-7xl lg:text-8xl text-white font-bold  mb-4">The</h1>
        <h1 className="text-3xl md:text-6xl text-white fnt mb-4">Blog</h1>
